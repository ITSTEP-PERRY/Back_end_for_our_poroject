...
| [ИЗМЕНЕНИЯ-2026-09-19.md](./ИЗМЕНЕНИЯ-2026-09-19.md) | Спринт к защите 19.09: админка React, PDP, notify, Docker, Swagger |
| [ИЗМЕНЕНИЯ-2026-09-17.md](./ИЗМЕНЕНИЯ-2026-09-17.md) | Сводка изменений API/категорий/каталога/PDP/auth + React-порт |
| [ИЗМЕНЕНИЯ-Account-2026-09-17.md](./ИЗМЕНЕНИЯ-Account-2026-09-17.md) | Account: wishlist, orders, settings + 14 скринов |
| [TRELLO-TODO.md](./TRELLO-TODO.md) | Нумерация задач (#1–#88) по макету Figma для доски Trello |
| [ПОРЯДОК-ЗАДАЧ-СПРИНТ.md](./ПОРЯДОК-ЗАДАЧ-СПРИНТ.md) | Желаемая последовательность; сейчас топ-5 к защите |
| [SMOKE-ЗАЩИТА.md](./SMOKE-ЗАЩИТА.md) | Чеклист Register→Login→Buy→Admin (#84) |
...
| [ACCOUNT-КАБИНЕТ.md](./ACCOUNT-КАБИНЕТ.md) | Wishlist / My orders / Settings по скринам account/01–14 |
| [РЕЧЬ-SMTP-ДЕМО.md](./РЕЧЬ-SMTP-ДЕМО.md) | Речь на 1 мин про stub SMTP (#88) |
| [SMTP-НАСТРОЙКА.md](./SMTP-НАСТРОЙКА.md) | Как включить реальный Gmail SMTP (#14) |
| [docker.md](./docker.md) | docker compose + `.env` для команды (#5) |
